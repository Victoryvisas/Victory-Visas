        ...
        >
          ...
          >
            <h2 className="text-base sm:text-lg font-semibold text-gray-800 text-center sm:text-left">
              Contact Us for Permanent Residency Assistance
            </h2>
            <form className="flex flex-col space-y-4 h-full">
              ...
              <motion.button
                type="submit"
                className="p-3 bg-green-500 text-white rounded-lg shadow hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
